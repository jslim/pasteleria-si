	...
	if (empty($_POST['id_cliente'])) {
		...
		$query_update = mysqli_query($con,$sql);
			if ($query_update){
				//////
				if($estado_factura=1){
				$sql1=mysqli_query($con, "select * from products, compra, detalle_compra where
				products.id_producto=detalle_compra.id_producto and
				compra.numero_factura=detalle_compra.numero_factura
				and compra.id_factura='".$id_factura."'");
