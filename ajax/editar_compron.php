...
{
$insert_tmp=mysqli_query($con, "INSERT INTO detalle_compra (numero_factura, id_producto,cantidad,precio_venta) VALUES ('$numero_factura','$id','$cantidad','$precio_venta')");
...
<?php
	$sumador_total=0;
	$sql=mysqli_query($con, "select * from products, compra, detalle_compra where compra.numero_factura=detalle_compra.numero_factura and  compra.id_factura='$id_factura' and products.id_producto=detalle_compra.id_producto");
