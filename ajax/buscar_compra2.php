<?php
	...
	if($action == 'ajax'){
		// escaping, additionally removing everything that could be (html/javascript-) code
		 ...
		 $sTable = "products";
		 $sWhere = "WHERE products.id_tipo=2 or products.id_tipo=3";
		if ( $_GET['q'] != "" )
		{
			$sWhere = "WHERE (";
			...
			<div class="table-responsive">
			  <table class="table">
				<tr  class="warning">
					...
					<th><span class="pull-right">Unidad</span></th>
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						<td><button type="button" class="btn btn-info"><?php echo $stock; ?></button></td>
						<td><?php echo $unidad; ?></button></td>
