<?php
	...
	if (empty($_POST['mod_id'])) {
		...
		$contacto=mysqli_real_escape_string($con,(strip_tags($_POST["mod_contacto"],ENT_QUOTES)));
		
		$id_cliente=intval($_POST['mod_id']);
		$sql="UPDATE proveedor SET nombre_cliente='".$nombre."', telefono_cliente='".$telefono."', email_cliente='".$email."', direccion_cliente='".$direccion."', status_cliente='".$estado."', rif='".$rif."', contacto='".$contacto."' WHERE id_cliente='".$id_cliente."'";
