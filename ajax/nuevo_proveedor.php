<?php
	...
	if (empty($_POST['nombre'])) {
		...
		$sql="INSERT INTO proveedor (nombre_cliente, rif, contacto, telefono_cliente, email_cliente, direccion_cliente, status_cliente, date_added) VALUES ('$nombre','$rif', '$contacto', '$telefono','$email','$direccion','$estado','$date_added')";
