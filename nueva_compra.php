  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-edit'></i> Nueva Orden de compra</h4>
		</div>
		...
		?>
			<form class="form-horizontal"  role="form"  id="datos_factura">
				<div class="form-group row">
				  ...
				  <div class="col-md-3">
					  <input type="text" class="form-control input-sm" id="nombre_cliente" id="nombre_cliente" placeholder="Selecciona un proveedor" required>
						...
						<div class="form-group row">
							...
							<div class="col-md-3">
								<select class="form-control input-sm" id="id_vendedor" disabled>
									<?php
										$sql_vendedor=mysqli_query($con,"select * from users where rol=3  order by lastname");
				...
				<div class="col-md-12">
					<div class="pull-right">
						...
						<button 
						type="button" id="buttonRegister"class="btn btn-default" data-toggle="modal" data-target="#myModal">
...
aqui /*/					
	...
	/*	function nombre(nombre_cliente)
		{
			$.ajax({
        type: "GET",
        url: "./ajax/buscar_compra.php",
