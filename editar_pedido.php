...
$active_pedidos="active";
	...
	if (isset($_GET['id_factura']))
	{
		...
		$campos=" ordenp.id_vendedor, ordenp.fecha_factura, ordenp.condiciones, ordenp.estado_factura, ordenp.numero_factura";
		$sql_factura=mysqli_query($con,"select $campos from ordenp where id_factura='".$id_factura."'");
...
<html lang="en">
  ...
  <body>
		...
		?>
			<form class="form-horizontal" role="form" id="datos_factura">
						...
						<div class="form-group row">
							...
							<div class="col-md-2">
								<select class='form-control input-sm ' <?php if ($estado_factura==2){echo "disabled";}?> id="estado_factura" name="estado_factura">
									<option value="1" <?php if ($estado_factura==1){echo "selected";}?>>Pendiente</option>
									<option value="2" <?php if ($estado_factura==2){echo "selected";}?>>Procesado</option>
								</select>
							</div>
						</div>
	...
	<script type="text/javascript" src="js/editar_pedido.js"></script>
