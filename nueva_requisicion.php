<?php
	...
	$title="Nueva Orden de Requisición";
  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-edit'></i> Nueva orden de requisición</h4>
		</div>
	...
	<script type="text/javascript" src="js/nueva_ordenR.js"></script>
