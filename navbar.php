...
<nav class="navbar navbar-default ">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Pastelería Italiana Venecia</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="<?php echo $active_productos;?>"><a href="productos.php"><i class='glyphicon glyphicon-barcode'></i> Productos</a>
        </li>
		...
		<li class="<?php echo $active_proveedor;?>"><a href="proveedor.php"><i  class='glyphicon glyphicon-lock'></i> Proveedor</a></li>

		<li class="<?php echo $active_categoria;?>"><a href="categoria.php"><i  class='glyphicon glyphicon-lock'></i> Categoria</a></li>

		<li class="<?php echo $active_pedido;?>"><a href="pedido.php"><i  class='glyphicon glyphicon-lock'></i> Pedido</a></li>

    <li class="<?php echo $active_compra;?>"><a href="compra.php"><i  class='glyphicon glyphicon-lock'></i> Compras</a></li>
