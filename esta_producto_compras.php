  ...
  <body>
	...
	<div class="container">
		<ul class="nav nav-tabs">
            ...
            <li role="presentation" class ="active" ><a href="esta_producto_compras.php">Materiales o Isumos más comprados</a></li>
...
$(function () {
    Highcharts.chart('container', {
        ...
        title: {
            text: 'TOP 5 de los productos que más se compran en la Pastelería Italiana Venecia'
        },
        subtitle: {
            text: ' '
        },
...
<?php 
$sql = sprintf("SELECT SUM(cantidad)  as total, nombre_producto FROM detalle_compra JOIN  products ON detalle_compra.id_producto=products.id_producto GROUP BY detalle_compra.id_producto order by total desc limit 5");
