...
$te=$rw_cliente['te'];
			...
			$nuevafecha = date("d/m/y", strtotime("+$te day", strtotime($fecha_factura)));
			echo $nuevafecha;
...
$nums=1;
$sumador_total=0;
$sql=mysqli_query($con, "select * from products, detalle_compra, compra where products.id_producto=detalle_compra.id_producto and detalle_compra.numero_factura=compra.numero_factura and compra.id_factura='".$id_factura."'");
...
while ($row=mysqli_fetch_array($sql))
	...
	?>
        ...
        <tr>
            ...
            <td class='<?php echo $clase;?>' style="width: 10%; text-align: center"><?php echo $unidad; ?></td>
