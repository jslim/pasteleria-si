  ...
  <body>
	...
	<div class="container">
		<ul class="nav nav-tabs">
			...
			<li role="presentation" class="active"><a href="materiales_debajo_min.php">Insumos o materiales por debajo del stock Min</a></li>
	...
	<script type="text/javascript" src="js/materiales_min.js"></script>
  </body>
</html>
