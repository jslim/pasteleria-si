  ...
  <body>
	...
	<div class="container">
		<ul class="nav nav-tabs">
            ...
            <li role="presentation" class="active"><a href="esta_producto_ventas.php">Productos más vendidos</a></li>
...
$(function () {
    Highcharts.chart('container', {
        ...
        title: {
            text: 'TOP 5 de los productos que más se venden en la Pastelería Italiana Venecia'
        },
        subtitle: {
            text: ' '
        },
...
<?php 
$sql = sprintf("SELECT SUM(cantidad)  as total, nombre_producto FROM detalle_factura JOIN  products ON detalle_factura.id_producto=products.id_producto GROUP BY detalle_factura.id_producto order by total desc limit 5");
