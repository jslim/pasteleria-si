			...
			<form class="form-horizontal" role="form" id="datos_factura">
				<div class="form-group row">
				  ...
				  <label for="mail" class="col-md-1 control-label">Cliente</label>
							<div class="col-md-3">
								<input type="text" class="form-control input-sm" id="mail" placeholder="Email" disabled value="<?php echo $email_cliente;?>">
							</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-3">
								<select class="form-control input-sm" id="id_vendedor" name="id_vendedor" >
									<?php
										$sql_vendedor=mysqli_query($con,"select * from users where rol=4 order by lastname");
							...
							<div class="col-md-2">
								<input type="text" class="form-control input-sm" id="fecha" value="<?php echo $fecha_factura;?>" disabled>
							</div>
