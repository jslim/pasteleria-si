  ...
  <body>
	...
	<div class="container">
		<ul class="nav nav-tabs">
			<li role="presentation" class="active"><a href="esta_produccion.php">Estadística de producción</a></li>
...
?>
            ...
            data: [
<?php 
$sql = sprintf("SELECT SUM(precio_venta)  as total FROM ordenp  JOIN  detalle_ordenp ON ordenp.numero_factura=detalle_ordenp.numero_factura  GROUP BY MONTH(fecha_factura)");
$result = mysqli_query($con, $sql);
