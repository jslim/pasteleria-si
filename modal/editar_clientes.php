		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
			  <div class="form-group">
				<label for="mod_nombre" class="col-sm-3 control-label">Cedula</label>
				<div class="col-sm-8">
			  ...
			  <div class="form-group">
				<label for="mod_email" class="col-sm-3 control-label">Nombre</label>
				<div class="col-sm-8">
				 <input type="text" class="form-control" id="mod_email" placeholder="Nombre completo" name="mod_email">
				</div>
			  </div>
